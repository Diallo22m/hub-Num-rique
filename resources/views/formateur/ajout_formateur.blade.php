...
<div class="modal fade" id="modalAddFormateur" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">

            <div class="modal-header ">
                <h5 class="modal-title">Enregistrer un formateur</h5>
            ...
            <form action="" method="POST">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Spécialité<strong class="text-danger"> * </strong></label>
